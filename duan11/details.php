    ...
    <div class="container">
        ...
        <section class="main">
            <section class="oder-product">
                <div class="title">
                    <section class="main-order">
                        <h1><?= $product['title'] ?></h1>
                        <div class="box">
                          <img src="<?='admin/product/'.$product['thumbnail'] ?>" width="400px" height="200px" alt="">
                            <div class="about">
                               <p><?= $product['content'] ?></p>
                                ...
                                <form action="submit_comment.php" method="post">
                                    <label for="comment">Để lại bình luận:</label><br>
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Thực đơn tại quán <span class="green">Sweet</span></h1>
                </div>
